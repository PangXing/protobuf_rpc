...
class EchoRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:goya.rpc.echo.EchoRequest) */ {
 public:
  EchoRequest();
  virtual ~EchoRequest();
...
class EchoResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:goya.rpc.echo.EchoResponse) */ {
 public:
  EchoResponse();
